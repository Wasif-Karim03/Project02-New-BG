...
export async function updateRecordAction(formData: FormData) {
  ...
  const parsed = studentRecordSchema.safeParse({
    ...
    fullNameBn: str(formData.get("fullNameBn")),
    fatherNameBn: str(formData.get("fatherNameBn")),
    motherNameBn: str(formData.get("motherNameBn")),
    ...
    familyMobile: str(formData.get("familyMobile")),
    addrVillage: str(formData.get("addrVillage")),
    addrPara: str(formData.get("addrPara")),
    addrPostOffice: str(formData.get("addrPostOffice")),
    addrThana: str(formData.get("addrThana")),
