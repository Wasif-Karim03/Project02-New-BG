  ...
  return (
    <div className={page}>
      ...
      <section className="mt-10">
        ...
        <p className="text-xs text-slate-500">Runs automatically on 30 December (23:00 Asia/Dhaka) via a scheduled job; this button is the manual fallback and can be run anytime. It deactivates every active student in one click. Deactivated students immediately disappear from the public website until they re-enroll for the new session. Re-enrolling is always a manual admin action — nothing is auto-reactivated or deleted. Audited.</p>
