...
export default async function DonorVerifyPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return (
    <main className="mx-auto w-full max-w-md px-6 py-16">
      ...
      <p className="mt-3 text-sm leading-relaxed text-ink-2">We emailed a 6-digit code. Enter it to activate your donor account. (In dev, the code prints to the server console.)</p>
