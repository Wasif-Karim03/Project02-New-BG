...
export default async function MentorApplyStartPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return (
    <main className="mx-auto max-w-lg px-6 py-12">
      ...
      <h1 className="mt-1 text-2xl font-bold">Join as a mentor</h1>
      <p className="mt-2 text-sm text-black/60">Create a mentor account, answer a few questions, and verify your email. An admin reviews every mentor application. Once approved, you can sign in and see the students assigned to you.</p>
      ...
      <form action={createMentorAccountAction} className="mt-8 rounded-lg border border-black/10 p-5">
